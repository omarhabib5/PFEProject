...
.e-card .e-card-separator {
  border-bottom: calc(var(--e-border) * 0.0625) solid rgba(var(--color-sf-outline-variant));
}
.e-card .e-card-header-caption .e-card-header-title {
  color: rgba(var(--color-sf-on-surface));
}
...
.e-card .e-card-actions a {
  ...
  border: calc(var(--e-border) * 0.0625) solid rgba(var(--color-sf-primary));
...
.e-card .e-card-actions a:hover {
  background: rgba(var(--color-sf-primary));
  border: calc(var(--e-border) * 0.0625) solid linear-gradient(0deg, rgba(var(--color-sf-on-surface), 0.08), rgba(var(--color-sf-on-surface), 0.08));
  color: rgba(var(--color-sf-on-primary));
}
...
.e-card .e-card-actions a:active {
  ...
  border: calc(var(--e-border) * 0.0625) solid linear-gradient(0deg, rgba(var(--color-sf-on-surface), 0.12), rgba(var(--color-sf-on-surface), 0.12));
  color: rgba(var(--color-sf-on-surface));
}
.e-card .e-card-content {
  color: rgba(var(--color-sf-on-surface));
